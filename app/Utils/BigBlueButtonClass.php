...
class BigBlueButtonClass
{
	 ...
	 public static function createMeeting($param = [])
	 {
	 ...
	 public static function closeMeeting($param = [])
	 {
		$meetingID 			= $param['meetingID'];
		$moderator_password	= $param['moderator_password'] ;
		$bbb = new BigBlueButton();
	 ...
	 public static function getMeetingInfo($param = [])
	 {
		$meetingID 			= $param['meetingID'];
		$moderator_password	= $param['moderator_password'] ;
		$bbb = new BigBlueButton();
	...
	public static function getRecordings($param = [])
	{
		$meetingID 	  = $param['meetingID'];
	...
	public static function deleteRecordings($param = [])
	{
		$recordingID = $param['recordingID'];
		// get from "Get Recordings"
	...
	public static function isMeetingRunning($param = [])
	{
	 	$meetingID = $param['meetingID'];
		$bbb = new BigBlueButton();
